                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <form enctype="multipart/form-data" action="{{url('admin_save-investigation-Report')}}" method="post" >
                                    @csrf
                                <div class="row form-group">
                                    <div class="col col-md-4">

                                        <label for="incident_id" class=" form-control-label">OB Number</label>
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-4">
                                        <label for="textarea-input" class=" form-control-label"> (Results) Investigation Statement  Report</label>
                                    </div>
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-4">
                                        <label for="textarea-input" class=" form-control-label">Recomendation </label>
                                    </div>
                                    <div class="col-12 col-md-9">
