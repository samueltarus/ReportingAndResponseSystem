...
class SuperAdminAssignmentController extends Controller
{
    ...
    public function all_assingments(){
        ...
        return view('superadmin.assingments.all_assingments',compact('assingments'));
    }
    ...
    public function create_assingment(){
        ...
        return view('superadmin.assingments.create_assingment',compact('clients','employees'));
    }
    ...
    public function save_assignments(Request $request){
        ...
        $data->save();
        return Redirect::to("admin_Assignments");
    ...
    public function show_assingment(Request $request ,$assingment_id){
        ...
        return view('superadmin.assingments.show_assingment',compact('assingment'));
    ...
    public function edit_assingment(Request $request,$assingment_id){
        ...
        return view('superadmin.assingments.edit_assingment',compact('assingment'));
    }
