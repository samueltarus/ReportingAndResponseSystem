...
class SuperAdminIncidentController extends Controller
{
    public function all_incidents(){
        ...
        return view('superadmin.incident.all_incidences',compact('incidences'));
    }
...
///load incidences
    ...
    public function load_incidents(){
        ...
        return view('superadmin.incident.load_incidence',compact('incidences'));
    }
    public function load_investigations(){

        $incidences = Investigation::with('incident')->get();

        return view('superadmin.incident.load_investigation',compact('incidences'));
    }
    ...
    public function add_investigation(){
        ...
        return view('superadmin.incident.add_investigation',compact('incidents'));
    }
    ...
    //   dd($data);
        ...
        return redirect::to('admin_load_investigation');
    ...
    public function show_employee(Request $request ,$employee_id){
        ...
        return view('superadmin.Incidents.show_Incident',compact('Incident','assingment'));
    ...
    public function edit_Incident(Request $request,$Incident_id){
        ...
        return view('superadmin.Incidents.edit_Incident',compact('Incident'));
    }
    ...
    public function all_assinged_Incidents(){
        ...
        return Redirect::to('admin_all_assinged');
    }
    ...
    return view('superadmin.Incidents.assing_assingment',compact('Incidents','assingments'));
    }
